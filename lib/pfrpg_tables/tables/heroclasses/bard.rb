  ...
  def self.level_bonus(level)
    ...
    when 1
      bonus = { :base_attack_bonus => [0],
                ...
                :choices => [],
                :spells_per_day => PfrpgTables::Tables::Spells::SpellsPerDay.Bard(1)
              }
    when 2
      bonus = { :base_attack_bonus => [1],
                ...
                :spells_per_day => PfrpgTables::Tables::Spells::SpellsPerDay.Bard(2)
              }
    when 3
      bonus = { :base_attack_bonus => [2],
                ...
                :choices => [],
                :spells_per_day => PfrpgTables::Tables::Spells::SpellsPerDay.Bard(3)
              }
    when 4
      bonus = { :base_attack_bonus => [3],
                ...
                :choices => [],
                :granted_features  => [],
                :spells_per_day => PfrpgTables::Tables::Spells::SpellsPerDay.Bard(4)
              }
    when 5
      bonus = { :base_attack_bonus => [3],
                :fort_save         => 1,
                ...
                :choices => [],
                :spells_per_day => PfrpgTables::Tables::Spells::SpellsPerDay.Bard(level)
              }
    when 6
